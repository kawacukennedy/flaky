...
describe('SearchFilter', () => {
  ...
  it('renders the filter button with the correct label and current value', () => {
    ...
    expect(screen.getByRole('button', { name: 'Source: All' })).toBeInTheDocument();
  });
  ...
  it('opens the dropdown when the button is clicked', () => {
    ...
    expect(screen.getByRole('menuitem', { name: 'CI Logs' })).toBeInTheDocument();
  });
  ...
  it('displays the correct active option', () => {
    ...
    expect(screen.getByRole('menuitem', { name: 'GitHub' })).toHaveClass('bg-primary text-white');
    expect(screen.getByRole('menuitem', { name: 'CI Logs' })).not.toHaveClass('bg-primary text-white');
  });
});