...
describe('GlobalToast', () => {
  ...
  it('renders a success toast message', () => {
    ...
    render(
      // <Provider store={store}>
        <GlobalToast message="Operation successful!" type="success" />
      // </Provider>
    );
  ...
  it('renders an error toast message', () => {
    ...
    render(
      // <Provider store={store}>
        <GlobalToast message="Operation failed!" type="error" />
      // </Provider>
    );
  ...
  it('renders an info toast message', () => {
    ...
    render(
      // <Provider store={store}>
        <GlobalToast message="Information alert!" type="info" />
      // </Provider>
    );
  ...
  it('renders a warning toast message', () => {
    ...
    render(
      // <Provider store={store}>
        <GlobalToast message="Warning!" type="warning" />
      // </Provider>
    );
  ...
  it('dispatches clearToast when the close button is clicked', () => {
    ...
    render(
      // <Provider store={store}>
        <GlobalToast message="Test message" type="info" onClear={mockClearToast} />
      // </Provider>
    );
  ...
  it('dispatches clearToast automatically after 5 seconds', async () => {
    ...
    render(
      // <Provider store={store}>
        <GlobalToast message="Auto-clear message" type="success" onClear={mockClearToast} />
      // </Provider>
    );
