...
describe('SolutionCard', () => {
  ...
  it('opens modal on card click', () => {
    ...
    expect(screen.getByText('Full content of the test solution.')).toBeInTheDocument();
  });
  ...
  it('calls handleCopyCode when Copy Code button is clicked', () => {
    ...
    expect(navigator.clipboard.writeText).toHaveBeenCalledWith(defaultProps.fullContent);
  });
});
