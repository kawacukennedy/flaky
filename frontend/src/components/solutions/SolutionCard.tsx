...
const SolutionCard: React.FC<SolutionCardProps> = ({
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <h3 className="text-lg font-semibold text-text_light dark:text-text_dark mb-2">
        {title}
      </h3>
      ...
      <div className="flex flex-wrap gap-2 mb-3">
        {tags.map((tag) => (
          <span
            key={tag}
            className="flex items-center text-xs bg-bg_light dark:bg-bg_dark text-muted px-2 py-1 rounded-full"
          >
      ...
      <div className="flex items-center justify-between text-sm text-muted">
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="flex items-center hover:text-primary transition-colors duration-fast"
