...
describe("DashboardPage", () => {
  it("renders the hero section with headline and subheadline", () => {
    ...
    expect(
      screen.getByText("Centralized debugging insights for developers."),
    ).toBeInTheDocument();
  });
  ...
  it("renders the CTA buttons", () => {
    ...
    expect(
      screen.getByRole("link", { name: "Start Hunting" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "View Flakes" }),
    ).toBeInTheDocument();
  });
  ...
  it('renders the "Overview" section', () => {
    ...
    expect(
      screen.getByText("More dashboard content will go here."),
    ).toBeInTheDocument();
  });
