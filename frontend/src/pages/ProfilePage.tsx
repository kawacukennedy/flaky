  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white shadow-md rounded-2xl p-6">
        <div className="mb-4">
          <label className="block text-text_secondary text-sm font-medium mb-2">Username:</label>
          {isEditing ? (
            <Input
              type="text"
              value={username}
        ...
        <div className="mb-4">
          <label className="block text-text_secondary text-sm font-medium mb-2">Email:</label>
          {isEditing ? (
            <Input
              type="email"
              value={email}
        ...
        <div className="mb-4">
          <label className="block text-text_secondary text-sm font-medium mb-2">Role:</label>
